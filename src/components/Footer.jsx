      ...
      <div className="footer-content">
        <div className="footer-brand">
          ...
          <div className="social-links">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/company/upekkha-foundation/" className="social-link" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-section">
          ...
          <ul>
            ...
            <li><a href="/our-people" onClick={e => { e.preventDefault(); navigate('/our-people') }}>Our People</a></li>
        ...
        <div className="footer-section">
          ...
          <p style={{ marginTop: '0.6rem' }}>
            <a href="https://www.linkedin.com/company/upekkha-foundation/" className="footer-contact-link" target="_blank" rel="noopener noreferrer">🔗 LinkedIn</a>
          </p>
        </div>
      </div>
